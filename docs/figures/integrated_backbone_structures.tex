...
% Panel A: T5
\node[title] (t5title) at (0, 0) {INR-T5 Encoder-Decoder};
\node[box, fill=blue!8, below=8mm of t5title] (t5score) {Score note nodes\\$(pitch,\ score\_continuous)$};
\node[box, fill=blue!16, right=of t5score] (t5encemb) {IntegratedNoteEncoder};
...
% Panel B: GPT
\node[title] (gpttitle) at (0, -55mm) {INR-GPT Decoder-Only};
\node[box, fill=blue!8, below=8mm of gpttitle] (gptscore) {Score note nodes};
\node[box, fill=blue!16, right=of gptscore] (gptencemb) {IntegratedNoteEncoder};
...
% Panel C: BERT
\node[title] (berttitle) at (0, -110mm) {INR-BERT Encoder-Only};
\node[box, fill=blue!8, below=8mm of berttitle] (bertscore) {Score note nodes\\$(pitch,\ score\_continuous)$};
\node[box, fill=blue!16, right=of bertscore] (bertencemb) {IntegratedNoteEncoder};
