...
class IntegratedPianoT5GemmaConfig(PianoT5GemmaConfig):
    def __init__(
        ...
        pn_ioi_w1_lambda=0.0,
        pp_ioi_w1_lambda=0.0,
        pn_duration_w1_lambda=0.0,
        pp_duration_w1_lambda=0.0,
        pn_velocity_w1_lambda=0.0,
        pp_velocity_w1_lambda=0.0,
        ioi_w1_normalizer=22.772456164440005,
        duration_w1_normalizer=75.08565114668764,
        velocity_w1_normalizer=10.580359191566208,
        ...
        **kwargs,
        ...
        self.pn_ioi_w1_lambda = float(pn_ioi_w1_lambda)
        self.pp_ioi_w1_lambda = float(pp_ioi_w1_lambda)
        self.pn_duration_w1_lambda = float(pn_duration_w1_lambda)
        self.pp_duration_w1_lambda = float(pp_duration_w1_lambda)
        self.pn_velocity_w1_lambda = float(pn_velocity_w1_lambda)
        self.pp_velocity_w1_lambda = float(pp_velocity_w1_lambda)
        self.ioi_w1_normalizer = float(ioi_w1_normalizer)
        self.duration_w1_normalizer = float(duration_w1_normalizer)
        self.velocity_w1_normalizer = float(velocity_w1_normalizer)
        self.pn_ioi_w1_normalizer = float(pn_ioi_w1_normalizer)
        self.pp_ioi_w1_normalizer = float(pp_ioi_w1_normalizer)
        self.pn_duration_w1_normalizer = float(pn_duration_w1_normalizer)
        self.pp_duration_w1_normalizer = float(pp_duration_w1_normalizer)
        self.pn_velocity_w1_normalizer = float(pn_velocity_w1_normalizer)
        self.pp_velocity_w1_normalizer = float(pp_velocity_w1_normalizer)
        self.ioi_w1_bins = int(ioi_w1_bins)
        self.duration_w1_bins = int(duration_w1_bins)
        self.ioi_w1_min = float(ioi_w1_min)
        self.ioi_w1_max = float(ioi_w1_max)
        self.duration_w1_min = float(duration_w1_min)
        self.duration_w1_max = float(duration_w1_max)
