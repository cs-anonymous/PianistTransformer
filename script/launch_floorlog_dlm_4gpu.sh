...
RUN_ROOT="${RUN_ROOT:-results/floorlog_dlm_4gpu/${STAMP}}"
...
variants = {
    "floorlog-dlm-k8-b256": {},
    "floorlog-dlm-k4-b256": {
        "epr_mixture_components": 4,
        "dlm_components": 4,
    },
    "floorlog-dlm-k8-b128": {
        "dlm_timing_bins": 128,
    },
    "floorlog-dlm-k8-b256-veldlm": {
...
launch_one 0 floorlog-dlm-k8-b256
launch_one 1 floorlog-dlm-k4-b256
launch_one 2 floorlog-dlm-k8-b128
launch_one 3 floorlog-dlm-k8-b256-veldlm
