...
RUN_ROOT="${RUN_ROOT:-results/floorlog_beta5_ln2_variance_4gpu/${STAMP}}"
...
variants = {
    ...
    "beta5-var-r005-l10": {
        ...
        "mixture_beta_parameterization": "mu_kappa",
        "mixture_beta_kappa_min": 1e-3,
        "predictive_variance_lambda": 10.0,
    },
    "ln2-support": {
...
launch_one 0 beta5-support
launch_one 1 beta5-var-r005-l10
launch_one 2 ln2-support
launch_one 3 ln2-var-r005-l10
